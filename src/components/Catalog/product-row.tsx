        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2 flex-wrap">
              ...
              {!product.caseConfig && (
                <span className="px-2 py-[2px] rounded bg-[#eef2ff] text-[10px] font-medium text-[#4f46e5]">
                  Single
                </span>
              )}
              {product.caseConfig && (
                <span className="px-2 py-[2px] rounded bg-[#f5f5f5] text-[10px] font-medium text-[#666]">
                  Case of {getCaseItemCount(product.caseConfig.layout)}
                </span>
              )}
              {product.autoGeneratedCase && (
                <span className="px-2 py-[2px] rounded bg-[#ecfdf5] text-[10px] font-medium text-[#047857]">
                  Auto
                </span>
              )}
            </div>
              ...
              <div className="absolute right-0 top-10 bg-white shadow-elevated rounded-lg z-20 py-1 w-36">
                {product.autoGeneratedCase ? (
                  <div className="px-3 py-2 text-[11px] text-[#888]">
                    Auto-generated variants are managed from the base product.
                  </div>
                ) : (
                  <button
