...
export function CameraController({
  ...
  useFrame((_, delta) => {
    ...
    controlsRef.current.target.x = MathUtils.clamp(controlsRef.current.target.x, -maxPanOffset, maxPanOffset);
    controlsRef.current.target.z = MathUtils.clamp(controlsRef.current.target.z, -maxPanOffset, maxPanOffset);
  });
