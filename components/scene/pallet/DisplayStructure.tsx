    ...
    <group>
      ...
      {isHalf ? (
        <>
          ...
          {/* Back wall - stops at shelf height, header sits on top with its own rounded shape */}
          <mesh castShadow position={[0, baseY + backHeight / 2, -halfD]} receiveShadow>
            <boxGeometry args={[tower.width, backHeight, wallThickness]} />
